...
struct TargetInterface : public PackageInterface<DerivedType> {
  ...
  virtual const BasicCollection<String> &sources_get() const = 0;
  virtual DerivedType &sources_set(const BasicCollection<String> &) = 0;
  virtual const BasicCollection<String> &dependencies_get() const = 0;
  virtual DerivedType &dependencies_set(const BasicCollection<String> &) = 0;
  virtual const BasicCollection<CompileCommandDescriptor> &
  compile_commands_get() const = 0;
  virtual DerivedType &
  compile_commands_set(const BasicCollection<CompileCommandDescriptor> &) = 0;
