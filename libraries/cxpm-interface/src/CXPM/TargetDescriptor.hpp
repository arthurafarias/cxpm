...
struct TargetDescriptor : public PackageDescriptor {
  ...
  String description = "";
  String toolchain = "g++";
  BasicCollection<String> sources;
  BasicCollection<String> dependencies;
  BasicCollection<CompileCommandDescriptor> compile_commands;
};
...
//   ar % AbstractArchiver::make_named_value_property("description",
//                                                    td.description);
//   ar % AbstractArchiver::make_named_value_property("include_directories",
//                                                    td.include_directories);
//   ar % AbstractArchiver::make_named_value_property("link_directories",
//                                                    td.link_directories);
//   ar % AbstractArchiver::make_named_value_property("link_libraries",
//                                                    td.link_libraries);
...
//   ar % AbstractArchiver::make_named_value_property("dependencies",
//                                                    td.dependencies);
//   ar % AbstractArchiver::make_named_value_property("compile_commands",
//                                                    td.compile_commands);
//   ar % AbstractArchiver::make_named_value_property("install_prefix",
//                                                    td.install_prefix);
